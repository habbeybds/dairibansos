...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{$data['action']}}" method="{{$data['method']}}">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="inputName">Jenis Bantuan</label>
                                <input type="text" name="jenis_bantuan" id="inputName" value="{{$data['data']['jenis_bantuan']}}" class="form-control" required>
                            </div>
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-6">
                    <a href="{{route('jenisbantuanlist')}}" class="btn btn-secondary">Cancel</a>
