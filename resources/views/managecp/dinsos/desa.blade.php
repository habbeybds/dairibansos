        ...
        <div class="card ovh">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('tambahdesa')}}"><button type="button" class="btn btn-tool btn-add" title="Tambah Jenis Bantuan">
                    ...
                    <tbody>
                        ...
                        @for ($i = 1; $i <= sizeof($results); $i++) <tr>
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a id="edit_{{$i}}" class="btn btn-info btn-sm" href="{{ route ('editdesa', $results[$i - 1]['id']) }}">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                    Edit
                                </a>
                                <form action="{{url('desa/'.$results[$i - 1]['id'])}}" method="POST" class="form-line">
                                    @csrf
                                    @method('POST')
